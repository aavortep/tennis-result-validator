...
class RankingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Ranking
        fields = [
            'id', 'player', 'tournament', 'tournament_name', 'position',
            'points', 'wins', 'losses', 'matches_played', 'win_percentage',
...
class RankingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Ranking
        fields = [
            'id', 'player_name', 'position', 'points',
...
class GlobalRankingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GlobalRanking
        fields = [
            'id', 'player', 'position', 'total_points',
            'total_wins', 'total_losses', 'tournaments_played',
            'tournaments_won', 'updated_at'
        ]
...
class GlobalRankingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GlobalRanking
        fields = [
            'id', 'player_name', 'position', 'total_points',
            'total_wins', 'total_losses', 'tournaments_played'
        ]
