...
urlpatterns = [
    path(
        ...
        views.TournamentLeaderboardView.as_view(),
    ...
    path(
        ...
        views.PlayerRankingsView.as_view(),
    ...
    path(
        ...
        views.InitializeTournamentRankingsView.as_view(),
        name="initialize-rankings",
    ),
    path(
        "tournament/<int:tournament_id>/recalculate/",
        views.RecalculateRankingsView.as_view(),
