...
urlpatterns = [
    ...
    path(
        "disputes/<int:pk>/", views.DisputeDetailView.as_view(), name="dispute-detail"
    ),
    path(
    ...
    path(
        ...
        views.DisputeReviewView.as_view(),
        name="dispute-review",
    ),
    path(
    ...
    path(
        "evidence/submit/", views.EvidenceCreateView.as_view(), name="evidence-submit"
    ),
]
