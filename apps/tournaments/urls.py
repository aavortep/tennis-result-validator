...
urlpatterns = [
    ...
    path(
        "<int:pk>/add-player/",
        views.TournamentAddPlayerView.as_view(),
        name="add-player",
    ),
    path(
        "<int:pk>/remove-player/<int:player_id>/",
        views.TournamentRemovePlayerView.as_view(),
        name="remove-player",
    ),
    path(
        "<int:pk>/add-referee/",
        views.TournamentAddRefereeView.as_view(),
        name="add-referee",
    ),
    path(
        "<int:pk>/status/",
        views.TournamentStatusView.as_view(),
    ...
    path(
        ...
        views.MatchAssignPlayersView.as_view(),
        name="assign-players",
    ),
    path(
        "matches/<int:pk>/assign-referee/",
        views.MatchAssignRefereeView.as_view(),
        name="assign-referee",
    ),
